...
namespace ColorTiming.Infrastructure.GF.Settings
{
    ...
    public sealed class GfColorTimingSettings : IColorTimingSettings
    {
        ...
        {
            get => !global::GF.Setting.GetMediaMute(Const.SoundGroup.BGM, false);
            set => SetSoundEnabled(value, Const.SoundGroup.BGM, Const.SoundGroup.Music);
        }

        public bool SfxEnabled
        {
            get => !global::GF.Setting.GetMediaMute(Const.SoundGroup.Player, false);
        ...
        void SetSoundEnabled(bool enabled, params Const.SoundGroup[] groups)
        {
            ...
            {
                global::GF.Setting.SetMediaMute(group, !enabled);
            }
